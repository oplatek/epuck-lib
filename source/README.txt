...
Requirements programs of this folder: 
	- .Net 2.0 or Mono 2.6.7 and higher to compile and run the programs	
...
Remarks for linux users:
	...
	The files are "interpreted" by Mono runtime.
          However the Elib library is little bit slower on Mono,
        because Mono does not implement DataReceivedCallback natively.
