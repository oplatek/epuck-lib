...
namespace Elib {
  ...
  public partial class Epuck:IDisposable{
    ...
    /// <summary>
    /// Eight Infra Red sensors are placed on perimeter of e-Puck, which can be obtained on instance e of e-Puck by e.BeginGetIRSensors(..) or e.GetIRSensors.
    ...
    /// <summary>
    /// Gets the BTCom version, which is a static property.
    /// </summary>
    ...
    /// <param name="Name">Choose a name for your robot. It is usefull in logging.</param>
    ...
    void logf(Action a, string method) {
      if (log)
        w.WriteLine("{0:F8} {1} {2} {3} {4} {5}", Stamp.Get(), name, a.ToString(), logFunctionNames[method], ser.NotSended, ser.NotAnswered);
    }
    ...
    /// <summary>
    /// Releases unmanaged(Serial Port in <see cref="Sercom"/> and access to log file) and - optionally - managed resources
    /// </summary>
