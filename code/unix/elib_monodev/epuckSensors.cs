...
namespace Elib {
  public partial class Epuck {
    ...
    static Bitmap parsingBitmap(byte[] pixs, int width, int height, int mode) {
      //IMPORTANT THE PICTURE FROM CAMERA IS ROTATED 90 DEGREES TO ?
    ...
    /////////////////////////////////////single functions //////////////////////////
    /// <summary>   
    /// Gets a picture. It can take a long time. E.g. piture 40*40 in colour takes ~0.4 s under good light conditions
    /// and with battery well charged.
    /// </summary>
    ...
    /// <summary>    Gets the proximity from IR sensors. Obstacle can be recongnized up to 4 cm.</summary>
    /// <param name="okf">A function called after the confirmation answer is received.</param>
    /// <param name="kof">A function called after the timeout is elapsed if the confirmation of command has not been received.</param>
    /// <param name="state">An instance of any class, which is passed to the callback function as an argument.</param>
    /// <param name="timeout">Timeout[ s ] set how long are you willing to wait for the command confirmation answer.</param>
    ...
    /// <summary>  Returns vector of values, which indicates the slant of e-Puck</summary>
    /// <param name="okf">A function called after the confirmation answer is received.</param>
    /// <param name="kof">A function called after the timeout is elapsed if the confirmation of command has not been received.</param>
    /// <param name="state">An instance of any class, which is passed to the callback function as an argument.</param>
    /// <param name="timeout">Timeout[ s ] set how long are you willing to wait for the command confirmation answer.</param> 
    ...
    /// <summary>    Returns a selector position</summary>
    /// <param name="okf">A function called after the confirmation answer is received.</param>
    /// <param name="kof">A function called after the timeout is elapsed if the confirmation of command has not been received.</param>
    /// <param name="state">An instance of any class, which is passed to the callback function as an argument.</param>
    /// <param name="timeout">Timeout[ s ] set how long are you willing to wait for the command confirmation answer.</param>
    ...
    /// <summary>Gets the current speed of both wheels. Speed on a wheel is from -1 to 1 </summary>
    /// <param name="okf">A function called after the confirmation answer is received.</param>
    /// <param name="kof">A function called after the timeout is elapsed if the confirmation of command has not been received.</param>
    /// <param name="state">An instance of any class, which is passed to the callback function as an argument.</param>
    /// <param name="timeout">Timeout[ s ] set how long are you willing to wait for the command confirmation answer.</param>
    ...
    /// <summary> Get current camera settings</summary>
    /// <param name="okf">A function called after the confirmation answer is received.</param>
    /// <param name="kof">A function called after the timeout is elapsed if the confirmation of command has not been received.</param>
    /// <param name="state">An instance of any class, which is passed to the callback function as an argument.</param>
    /// <param name="timeout">Timeout[ s ] set how long are you willing to wait for the command confirmation answer.</param>
    ...
    /// <summary>Get ambient light from IR sensors. The smaller values the greater light.</summary>
    /// <param name="okf">A function called after the confirmation answer is received.</param>
    /// <param name="kof">A function called after the timeout is elapsed if the confirmation of command has not been received.</param>
    /// <param name="state">An instance of any class, which is passed to the callback function as an argument.</param>
    /// <param name="timeout">Timeout[ s ] set how long are you willing to wait for the command confirmation answer.</param>
    ...
    /// <summary>Gets a current state of encoders. It is measured in steps. It is nulled if the e-Puck resets.</summary>
    /// <param name="okf">A function called after the confirmation answer is received.</param>
    /// <param name="kof">A function called after the timeout is elapsed if the confirmation of command has not been received.</param>
    /// <param name="state">An instance of any class, which is passed to the callback function as an argument.</param>
    /// <param name="timeout">Timeout[ s ] set how long are you willing to wait for the command confirmation answer.</param>
    ...
    /// <summary> Gets the current amplitude of sound.(Sound strenght}   </summary>
    /// <param name="okf">A function called after the confirmation answer is received.</param>
    /// <param name="kof">A function called after the timeout is elapsed if the confirmation of command has not been received.</param>
    /// <param name="state">An instance of any class, which is passed to the callback function as an argument.</param>
    /// <param name="timeout">Timeout[ s ] set how long are you willing to wait for the command confirmation answer.</param>
    ...
    /// <summary>
    /// Gets the IR data in in array of 3 ints converted from hex number with following meaning.
