...
namespace Elib {
  public partial class Sercom {
    ...
    myQueue notSended = new myQueue();
    priorQueue notSendedSTS=new priorQueue() ;//locks at not at notSendedLock
    object notSendedLock=new object();
    ...
    EventWaitHandle checkSDwh = new EventWaitHandle(false, EventResetMode.AutoReset);
    EventWaitHandle hshake_sendedUpdateWh = new EventWaitHandle(true, EventResetMode.ManualReset);
    ansGuard hshake_sended=null;
    object hsshake_sendedLock = new object();
    
    int notAnswered=0;
    volatile bool stableans = false;
    volatile bool disposed=false;
    volatile bool stopped_send=false;
    volatile bool stopped_confirm=false;
