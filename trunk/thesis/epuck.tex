...
\label{chap:epuck}
  ...
  with an~description of the~e-Puck's mechanical design. Section \ref{sec:sensors} is devoted to e-Puck's sensors and actuators. 
  ...
  The chapter finishes with a description of an e-Puck's camera and outlining other e-Puck abilities.
